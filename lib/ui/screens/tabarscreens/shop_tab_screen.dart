...
class _ShopTabScreenState extends State<ShopTabScreen>
  ...
  void initState() {
    super.initState();
    _tabBarController = new TabController(vsync: this, length: 4, initialIndex: 0);
            ...
            SafeArea(child:Column(
              children: <Widget>[
                Padding(
                  child:Row(
                  children:[
                    GestureDetector(child:ImageIcon(AssetImage(UIData.hambMenu),color: Colors.white,),onTap: ()=>_scaffoldKey.currentState.openDrawer()),
                ...
                Padding(child:
                TabBar(tabs: [
                  _tabBarController.index==0?Container(decoration: BoxDecoration(color: Colors.transparent,border: Border.all(color: Colors.white),borderRadius: BorderRadius.circular(20.0)),
                  ...
                  _tabBarController.index==1?Container(decoration: BoxDecoration(color: Colors.transparent,border: Border.all(color: Colors.white),borderRadius: BorderRadius.circular(20.0)),
                      padding: EdgeInsets.only(top: 10.0,bottom: 10.0),width: 120.0,
                  ...
                  _tabBarController.index==2?Container(decoration: BoxDecoration(color: Colors.transparent,border: Border.all(color: Colors.white),borderRadius: BorderRadius.circular(20.0)),
                      padding: EdgeInsets.only(top: 10.0,bottom: 10.0),width: 120.0,
                  ...
                  _tabBarController.index==3?Container(decoration: BoxDecoration(color: Colors.transparent,border: Border.all(color: Colors.white),borderRadius: BorderRadius.circular(20.0)),
                      padding: EdgeInsets.only(top: 10.0,bottom: 10.0),width: 120.0,
                ...
                ],controller: _tabBarController,labelColor: Colors.transparent,indicatorColor: Colors.transparent,isScrollable: true,onTap: (val)=> setState((){
                ...
                Expanded(child: GridView.count(
                  ...
                  children: _categories.map<Widget>((value)=> GestureDetector(child:ShopCard(item:value,color: _color),onTap:()=> shopItem(_tabBarController.index,value))).toList()
                  ,shrinkWrap: true,
                )),
