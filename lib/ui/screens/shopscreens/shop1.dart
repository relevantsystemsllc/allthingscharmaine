...
import 'package:allthingscharmaine/ui/widgets/shopBottomSheet.dart';
import 'package:allthingscharmaine/ui/widgets/shopCards.dart';
...
class Shop1State extends State<Shop1> with SingleTickerProviderStateMixin {
            ...
            child: Column(
              children: <Widget>[
                Row(
                  children: [
                    ImageIcon(
                      AssetImage("assets/hamb menu.png"),
                      color: Colors.white,
                    ),
                    Text(
                      "shop",
