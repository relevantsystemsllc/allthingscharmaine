...
class Shop2State extends State<Shop2> {
  ...
  void initState() {
    ...
    color = [Colors.green[100],Colors.green[100],Colors.green[200],Colors.green[100],Colors.green[100]];
  ...
  Widget build(BuildContext context) {
    ...
    children:[Row(
                  ...
                  Align(child:Padding(child:Text("approns",style: TextStyle(fontSize: 30.0,color: Colors.white,fontWeight: FontWeight.bold),),padding: EdgeInsets.only(left: 40.0),),alignment: Alignment.centerLeft,),
     SingleChildScrollView(
        child: Row(
          children: <Widget>[
            Image.asset("assets/approns 1.png",fit: BoxFit.fitHeight,height: 200.0),
            Image.asset("assets/approns 2.png",fit: BoxFit.fitHeight,height: 350.0),
            Image.asset("assets/approns 3.png",fit: BoxFit.fitHeight,height: 200.0),
      ...
      Padding(padding: EdgeInsets.only(left: 30.0),child: Text("\$35",style: TextStyle(color: Colors.green[200],fontSize: 22.0,fontWeight: FontWeight.bold))),
      Padding(padding: EdgeInsets.only(left: 30.0),child: Text("cook eat happy",style: TextStyle(color: Colors.black,fontSize: 20.0,fontWeight: FontWeight.normal))),
      Padding(padding: EdgeInsets.only(left: 30.0,right: 50.0),child: Text("cook eat happy cook eat happy cook eat happy cook eat happy cook eat happy cook eat happy cook eat happy cook eat happy",style: TextStyle(color: Colors.black26,fontSize: 13.0,fontWeight: FontWeight.normal))),
      SizedBox(height: 20.0),
      Container(
        height: 20.0,
        width: 300.0,
